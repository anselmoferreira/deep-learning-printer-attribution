function main(fold)
	...
	[imdb, ground_truth_documents_test, char_per_document_test]=generate_imdb(opts,fold,'raw');
	...
	save(['Data/Fold-' num2str(fold) '/imdb-raw-images-fold-' int2str(fold) '.mat'], '-struct', 'imdb');
...
%Disp(['Mean accuracy for network applied on raw letters E is: ' num2str(mean)]);
